   ...
   <div id="content" class="contentsecwrap">
      <header class="page-header">
        ...
        <span><?php classic_coffee_shop_the_breadcrumb(); ?></span>
         ...
         <?php
         $classic_coffee_shop_sidebar_layout = get_theme_mod( 'classic_coffee_shop_sidebar_post_layout','right');
         if($classic_coffee_shop_sidebar_layout == 'left'){ ?>
         <div class="row m-0">
         ...
         <div class="clearfix"></div>
         <?php }else if($classic_coffee_shop_sidebar_layout == 'right'){ ?>
            <div class="row m-0">
               <div class="col-lg-8 col-md-8">
                  <div class="postsec-list">
                     <?php if ( have_posts() ) : ?>                        
         ...
         <?php }else if($classic_coffee_shop_sidebar_layout == 'full'){ ?>
            <div class="full">
              <div class="postsec-list">
                 <?php if ( have_posts() ) : ?>                        
                    <div class="postsec-list">
         ...
         <?php }else if($classic_coffee_shop_sidebar_layout == 'three-column'){ ?>
            <div class="row m-0">
         ...
         <?php }else if($classic_coffee_shop_sidebar_layout == 'four-column'){ ?>
            <div class="row m-0">
               <div class="col-lg-3 col-md-3" id="sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
         ...
         <?php }else if($classic_coffee_shop_sidebar_layout == 'grid'){ ?>
            <div class="row m-0">
